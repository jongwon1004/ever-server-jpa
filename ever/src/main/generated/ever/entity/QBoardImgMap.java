...
public class QBoardImgMap extends EntityPathBase<BoardImgMap> {
    ...
    private static final long serialVersionUID = 65820228L;
    ...
    public final ever.entity.middle.QBoardImgMapId id;
    ...
    public QBoardImgMap(Class<? extends BoardImgMap> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new ever.entity.middle.QBoardImgMapId(forProperty("id")) : null;
