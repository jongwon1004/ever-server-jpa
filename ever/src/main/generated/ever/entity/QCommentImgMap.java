...
public class QCommentImgMap extends EntityPathBase<CommentImgMap> {
    ...
    private static final long serialVersionUID = -1230282307L;
    ...
    public final ever.entity.middle.QCommentImgMapId id;
    ...
    public QCommentImgMap(Class<? extends CommentImgMap> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new ever.entity.middle.QCommentImgMapId(forProperty("id")) : null;
